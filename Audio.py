...
def musicurl():
    try:
        dd = filedialog.askopenfilename(initialdir='C:Users/ASUS/Desktop/codes',
                                        ...
                                        filetype=(('MP3','.mp3'),('WAV','.wav'),('WEBM','.webm')))
    except:
...
def createwidthes():
    ...
    #  Labels
    TrackLabel = Label(root,text='Select Audio Track : ',background='lightsalmon',font=('arial',15,'italic bold'))
    TrackLabel.grid(row=0,column=0,padx=20,pady=20)

    AudioStatusLabel = Label(root,text='',background='lightsalmon',font=('arial',15,'italic bold'),width=20)
    ...
    # Buttons
    BrowseButton = Button(root,text='Search',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
                          activebackground='purple4',image=imbrowse,compound=RIGHT,command=musicurl)
    BrowseButton.grid(row=0,column=2,padx=20,pady=20)

    PlayButton = Button(root,text='Play',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
                        activebackground='purple4',image=implay,compound=RIGHT,command=playmusic)
    PlayButton.grid(row=1,column=0,padx=20,pady=20)

    root.PauseButton = Button(root,text='Pause',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
    ...
    root.ResumeButton = Button(root,text='Resume',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
    ...
    root.mutebutton = Button(root,text='Mute',width=100,bg='gold',activebackground='purple4',bd=5,
                             image=immute,compound=RIGHT,command=mutemusic)
    root.mutebutton.grid(row=3,column=3)
    root.mutebutton.grid_remove()

    root.unmutebutton = Button(root,text='UnMute',width=100,bg='gold',activebackground='purple4',bd=5,
                             image=imunmute,compound=RIGHT,command=unmutemusic)
    root.unmutebutton.grid(row=3,column=3)
    root.unmutebutton.grid_remove()

    VolumeUpButton = Button(root,text='VolumeUp',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
    ...
    StopButton = Button(root,text='Stop',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
                        activebackground='purple4',image=imstop,compound=RIGHT,command=stopmusic)
    StopButton.grid(row=2,column=0,padx=20,pady=20)

    VolumeDownButton = Button(root,text='VolumeDown',bg='gold',font=('arial',13,'italic bold'),width=200,bd=5,
    ...
    #  Progressbar Volume
    ProgressbarLabel = Label(root,text='',bg='gold')
    ...
    ProgressbarVolumeLabel = Label(ProgressbarLabel,text='0%',bg='gold',width=3)
    ProgressbarVolumeLabel.grid(row=0,column=0)
    ProgressbarLabel.grid_remove()

    #ProgressBar Music
    ProgressbarMusicLabel = Label(root,text='',bg='gold')
    ProgressbarMusicLabel.grid(row=3,column=0,columnspan=3,padx=20,pady=20)
    ProgressbarMusicLabel.grid_remove()

    ProgressbarMusicStartTimeLabel = Label(ProgressbarMusicLabel, text='0:00:0', bg='gold',width=6)
    ...
    ProgressbarMusicEndTimeLabel = Label(ProgressbarMusicLabel,text='0:00:0', bg='gold')
...
root.title('422 rockstars Audio Player..')
...
text = ''
#  Create Slider
ss = '422 Rockstars Audio Player'
SliderLabel = Label(root,text=ss,bg='lightsalmon',font=('arial',40,'italic bold'))
